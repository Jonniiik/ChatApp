...
public class ProfileFragment extends Fragment {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (user.getImageURL().equals("default")) {
                    profileImageFrProfile.setImageResource(R.drawable.mignon_wolverine);
                } else {
    ...
    private void uploadImage() {
        ...
        if (imageIri != null) {
            ...
            Toast.makeText(getContext(), getString(R.string.ImageNoSelected), Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == IMAGE_REQUEST && resultCode == RESULT_OK && data != null && data.getData() != null){
            ...
            if (uploadTask != null && uploadTask.isInProgress()){
                Toast.makeText(getContext(), getString(R.string.UploadInProgress), Toast.LENGTH_SHORT).show();
            } else {
                uploadImage();
            }
        }
